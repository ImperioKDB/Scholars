...
//
// missingLabels (gap-closing nudges) is rendered as plain text for the
// same reason SaveButton is a sibling: it would otherwise need its own
// <a> nested inside the card's Link, which is invalid HTML and silently
// breaks the whole card's clickability -- exactly the bug this file is
// fixing. If a "fix your profile" tap target is wanted here later, it
// needs to sit outside the Link, not inside it.
