...
//
// INPUT HARDENING: application_url is http(s)-only (httpUrlSchema) --
// z.string().url() accepted javascript:/data: URLs, and this value is
// opened via window.open in the student UI.
