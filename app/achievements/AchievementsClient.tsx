    ...
    <div>
      <div className="mb-8">
        ...
        <div className="bg-white rounded-xl border border-hairline p-5">
          ...
          {/* MOTION/FEEDBACK (item 4): animate transform: scaleX instead of
          width. width is a layout property (thrash on every frame); scaleX
          with origin-left is compositor-only and visually identical. The
          inner div is a normal block (100% wide), so scaleX(0..1) reveals
          it left-to-right. Reduced motion drops the transition but keeps
          the correct final scale. */}
