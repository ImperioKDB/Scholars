...
.limit(1),
// Needs migration 0018's profile_reminder_last_sent_at column. Before
// the migration this query errors and data is null -- the button then
// simply shows no "last reminder" line. Degrades, never fails the page.
supabase
.from("profiles")
