...
export default function AdminDiscoveryPage() {
  ...
  async function review(candidateId: string, nextStatus: 'approved' | 'rejected' | 'stale') {
    setBusy(candidateId)
