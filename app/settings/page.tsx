...
// and, since the privacy-transparency batch, self-serve account deletion
// via the DeleteAccountButton client component.
type ProfileRow = {
...
export default async function SettingsPage() {
  ...
  return (
    <div>
      ...
      {/* DELETE ACCOUNT (user feedback batch): self-serve erasure via the
          DeleteAccountButton client component, which owns the confirm
          dialog state and the DELETE /api/profile call. */}
